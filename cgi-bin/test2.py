...
select += "</select>"
form = ("""<form action = "upload2.py" method = "post" target = "_blank">
...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
   ...
   <a href="home2.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Home</a>
    <a href="upload.html" class="w3-bar-item w3-button w3-theme-l1" >Upload</a>
