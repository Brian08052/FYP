...
if (dataID != None and sampleID != None):
  ...
  print(dataID, '<br>', sampleID, '<br>', data, '<br>')
  so = sampleObject(dataID, sampleID, data)
  
  sampleData = so.getAlteredAxes()
  #Ok this should be a straight forward dataBase request, but ok.
...
</html>"""%(sampleObjectName, sampleObjectName, sampleObjectData, imageCode, formCode, sampleData))
